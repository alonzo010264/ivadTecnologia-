...
function renderTable(list, total) {
  ...
  <div style="overflow-x:auto">
    <table>
      <thead><tr>
        <th>Fecha</th><th>Tipo</th><th>Categoría</th><th>Descripción</th><th>Proveedor</th><th>Método</th><th class="right">Monto</th><th style="text-align:center">Evidencia</th><th style="text-align:center">Comprobante</th>
      </tr></thead>
      <tbody>
        ${list.map(r => {
